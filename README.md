...
1) Создайте приложение на [этой странице](https://vk.com/apps?act=manage), в настройках приложения найдите ID приложения и вставьте в соответствующую переменную APP_ID в начале скрипта get_token.py. Далее введите в соответствующие переменные свой логин и пароль (украсть эти данные невозможно, т.к. в коде нет ни одной строки, отправляющей куда-либо данные).
Запустите get_token.py. 
Скопируйте токен, который отобразится на экране
